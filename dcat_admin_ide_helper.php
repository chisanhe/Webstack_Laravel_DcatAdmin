...
namespace Dcat\Admin {
     ...
     * @property Grid\Column|Collection banner_img
     ...
     * @method Grid\Column|Collection banner_img(string $label = null)
     ...
     * @property Show\Field|Collection banner_img
     ...
     * @method Show\Field|Collection banner_img(string $label = null)
